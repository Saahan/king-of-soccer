...
export default function PassNeutral(props) {
  ...
  img.src = "/img/throwin.png";

  return (
    imgLoaded === true && (
      <div className="center-div">
        <img src="/img/throwin.png" alt="goal" width={400} height={300}></img>
        <p className="scenario-p">
          "The pass is inaccurate and the ball goes out of play. Throw in!"
        </p>
        <div
          className="button"
          onClick={() => {
