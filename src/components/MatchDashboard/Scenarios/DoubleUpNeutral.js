...
export default function DoubleUpNeutral(props) {
  ...
  img.src = "/img/fulltime.png";

  return (
    imgLoaded === true && (
      <div className="center-div">
        <img src="/img/fulltime.png" alt="goal" width={400} height={300}></img>
        <p className="scenario-p">
          "The tactic is not executed well and a free kick is conceded! Play
          resumes."
        </p>
        <div
          className="button"
