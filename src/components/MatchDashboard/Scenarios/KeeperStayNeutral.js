...
export default function KeeperStayNeutral(props) {
  ...
  img.src = "/img/keeperpunch.png";

  return (
    imgLoaded === true && (
      <div className="center-div">
        <img
          src="/img/keeperpunch.png"
          alt="goal"
          width={400}
          height={300}
        ></img>
        <p className="scenario-p">
          "The keeper stays on his line and the shot goes wide. Lucky!"
        </p>
        <div
          className="button"
          onClick={() => {
